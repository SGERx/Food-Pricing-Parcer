...
def update_expensive_products():
    ...
    if len(check_data) == 0:
        ...
        # with open(f'../data/e_query_results/expensive_products.csv', 'w', newline='') as file:
        #     writer = csv.writer(file)
        #     writer.writerow(test_header)
        #     writer.writerows(rows)

        if not os.path.exists(f'../data/e_query_results/query_4-expensive_products.xlsx'):
            with open(f'../data/e_query_results/query_4-expensive_products.xlsx', 'w'):
                pass

        # OpenPyXL
        filepath = f'../data/e_query_results/query_4-expensive_products.xlsx'
        workbook_create = openpyxl.Workbook()
        workbook_create.save(filepath)

        wb = openpyxl.load_workbook(f'../data/e_query_results/query_4-expensive_products.xlsx')
        ...
        wb.save(f'../data/e_query_results/query_4-expensive_products.xlsx')
