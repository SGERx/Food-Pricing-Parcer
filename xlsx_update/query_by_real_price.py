...
def update_real_price_xlsx():
    ...
    if len(check_data) == 0:
        ...
        # with open(f'../data/e_query_results/1_by_real_price.csv', 'w', newline='') as file:
        #     writer = csv.writer(file)
        #     writer.writerow(test_header)
        #     writer.writerows(rows)

        if not os.path.exists(f'../data/e_query_results/query_2-by_real_price.xlsx'):
            with open(f'../data/e_query_results/query_2-by_real_price.xlsx', 'w'):
                pass

        # OpenPyXL
        filepath = f'../data/e_query_results/query_2-by_real_price.xlsx'
        workbook_create = openpyxl.Workbook()
        workbook_create.save(filepath)

        wb = openpyxl.load_workbook(f'../data/e_query_results/query_2-by_real_price.xlsx')
        ...
        wb.save(f'../data/e_query_results/query_2-by_real_price.xlsx')
