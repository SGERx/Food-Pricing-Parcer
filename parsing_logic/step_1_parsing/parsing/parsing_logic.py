...
def input_parsing():
    ...
    if len(parsing) > 0:
        ...
        products_raw = pandas.read_csv(f"../../../../data/a_data_input/product_list.csv", encoding='ANSI')
...
def write_to_csv(data, csv_name):
    ...
    with open(f"../../../data/b_data_output/{current_date}_{csv_name}.csv", mode='w', encoding='utf-8-sig',
              newline='') as file:
